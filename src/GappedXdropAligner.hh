...
namespace cbrc {
    ...
    public:
        ...
        std::size_t numAntidiagonals() const { return seq1starts.size(); }

        std::size_t seq1start(std::size_t antidiagonal) const { return seq1starts[antidiagonal]; }

        std::size_t numCellsAndPads(std::size_t antidiagonal) const {
            return scoreEnds[antidiagonal + 1] - scoreEnds[antidiagonal];
        }

        std::size_t scoreEndIndex(std::size_t antidiagonal) const { return scoreEnds[antidiagonal]; }
