...
namespace cbrc {
    ...
    T whichFrame(std::size_t antidiagonal, T frame0, T frame1, T frame2) {
        switch (antidiagonal % 3) {
            case 0:
                return frame1;  // the +1 frame
            case 1:
                return frame2;  // the -1 frame
            case 2:
                return frame0;
            default:
                assert(0);  // keeps my compiler happy
        }
    }
